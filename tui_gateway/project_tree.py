...
def _project_node(
    *,
    ...
    color: Any = None,
    icon: Any = None,
    factory_slug: Any = None,
    matrix_room_id: Any = None,
    factory_lifecycle: Any = None,
    is_auto: bool = False,
    ...
    return {
        ...
        "color": color,
        "icon": icon,
        "factorySlug": factory_slug,
        "matrixRoomId": matrix_room_id,
        "factoryLifecycle": factory_lifecycle,
        "isAuto": is_auto,
    ...
    for project in active_projects:
        ...
        result.append(
            _project_node(
                ...
                factory_slug=project.get("factory_slug"),
                matrix_room_id=project.get("matrix_room_id"),
                factory_lifecycle=project.get("factory_lifecycle"),
                repos=repos,
